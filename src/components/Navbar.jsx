...
import { BsSliders, BsChevronDown, BsChevronUp } from "react-icons/bs"; //BsSliders2
...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      <div>
        <button className="navbarButton" onClick={() => setSlider(!slider)}>
          <BsSliders />
          <p>Display </p>
          {!slider ? <BsChevronDown /> : <BsChevronUp />}
        </button>
